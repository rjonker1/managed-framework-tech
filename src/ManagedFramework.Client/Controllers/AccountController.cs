...
using ManagedFramework.Core.ViewModels.AccountViewModels;

namespace ManagedFramework.Client.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Logout(LogoutViewModel model)
        {
            ...
            await _persistedGrantService.RemoveAllGrantsAsync(subjectId, "managed-framework-client1");

            return Redirect(Config.HostUrl + "/index.html");
