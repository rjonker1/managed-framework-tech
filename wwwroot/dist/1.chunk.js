...
var routes = [
    { path: '', children: [
            ...
            { path: 'child-barrel', loadChildren: function() { return __webpack_require__.e/* import() */(7).then(__webpack_require__.bind(null, 219))  .then( function(module) { return module['ChildBarrelModule']; } ); } }
        ] },
];
